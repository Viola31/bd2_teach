...
namespace bd2_teach.Controllers
{
    public class DisciplinesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Discipline_id,Dis_name")] Discipline discipline)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Discipline_id,Dis_name")] Discipline discipline)
        {
            if (ModelState.IsValid)
            {
